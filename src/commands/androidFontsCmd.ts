...
export async function generateAndroidFontsCommand(projectPath: string) {
...
export const androidFontsCmdSchema = createSubcommand({
  name: "generate-fonts",
...
androidFontsCmdSchema.setAction(async ({ path }) => {
